...
const Invest = () => {
  return (
    <div className='mx-auto max-tablet:flex flex-col max-tablet:flex-col' style={{ backgroundColor: '#F2F7F8' }}>
      <section className='flex justify-between items-center max-w-[1280px] px-16 pt-20' style={{ backgroundColor: 'hsl(269, 85%, 49%)' }}>
        <div className='text-white'>
          ...
          <span className='bg-white text-xl mb-8 inline-block px-6 py-3 rounded-4xl' style={{ color: 'hsl(269, 85%, 49%)', backgroundColor: '#EFF5FC' }}>
            Up to 35% returns
          </span>
          ...
          <div className='flex gap-4 mb-8'>
            <PiggyBtn title="GetOniphone" textColor="white" bgColor="#122231" iconTitle={<FaApple className='h-10' />} />
            <PiggyBtn title="GetonAndroid" textColor="#white" bgColor="#122231" iconTitle={<FaGooglePlay className='h-10' />} />
          </div>
        </div>
        <div>
      ...
      <section style={{ height: '80vh' }} className='max-w-[1280px] flex justify-between items-center mb-24'>
